...
``adsorbgen.eval.compute_anomaly_metrics`` with the user-defined protocol
...
Usage:
    PYTHONPATH=AdsorbGen python -m adsorbgen.scripts.rescore_anomaly \
...
from adsorbgen.eval import compute_anomaly_metrics
