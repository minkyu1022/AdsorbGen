...
from adsorbgen.data.dataset import PlacementPriorDataset, PreprocessedDisplacementDataset, collate_displacement  # noqa: E402
from adsorbgen.flow import FKSteeringConfig, FlowConfig, euler_sample  # noqa: E402
from adsorbgen.models.dit import DiTDenoiser, DiTDenoiserConfig  # noqa: E402
...
def main():
    ...
    for batch in loader:
        ...
        if args.fk_particles > 0:
            if args.fk_energy == "uma":
                from adsorbgen.evaluation.energy import make_fk_energy_fn  # noqa: WPS433
        ...
        if movable_mode == "surface_ads":
            movable = work["movable_mask"]
        elif movable_mode == "adsorbate_only":
            movable = work["movable_mask"] & (work["tags"] == 2)
        else:
