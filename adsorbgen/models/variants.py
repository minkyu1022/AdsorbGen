...
Usage from the CLI:
    ...
    python -m adsorbgen.training.train_cli --variant v3-no-mic-dist --out runs/v3-no-mic-dist ...
...
VARIANTS: dict[str, dict[str, Any]] = {
    ...
    # plus per-adsorbate-atom relative-position head. Pair-distance losses are
    # still controlled independently by train.py CLI flags.
    "v0-ads-ref-catflow-center-rel": {
        "atom_s": 512, "atom_z": 256,
